...
extension ClassElementEx on ClassElement {
  ...
  RealmModelInfo? get realmInfo {
    try {
      ...
      final objectType = ObjectType.values[
          modelInfo.value.getField('type')!.getField('index')!.toIntValue()!];
      ...
      final mappedFields = fields.realmInfo.toList()
        ..sort((a, b) =>
            a.isComputed ^ b.isComputed ? (a.isComputed ? 1 : -1) : -1);
      ...
      return RealmModelInfo(
          name, modelName, realmName, mappedFields, objectType);
